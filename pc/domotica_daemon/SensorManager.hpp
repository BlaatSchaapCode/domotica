...
class SensorManager {
 public:
  ...
  void nodeInfoAddSensor(uint32_t dongle_id, uint8_t node_id, uint8_t sensor_id,
                         uint8_t sensor_flags);
  void nodeInfoAddSwitch(uint32_t dongle_id, uint8_t node_id, uint8_t switch_id,
  ...
  void nodeValueAddSensor(uint32_t dongle_id, uint8_t node_id,
                          uint8_t sensor_id, uint8_t sensor_flags, float value);
  void nodeValueAddSwitch(uint32_t dongle_id, uint8_t node_id,
  ...
  void dongleNodeCommunicationStatus(uint32_t dongle_id, uint8_t node_id,
